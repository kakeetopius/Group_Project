...
public class Course {
    ...
    public void displayDetails() {
        System.out.println("BaseClasses.Course Name: " + this.coursename);
        System.out.println("BaseClasses.Course Number: " + this.getCourseid());
        System.out.println("Credit: " + this.credit);
        if (this.getLecturer() != null) {
            System.out.println("BaseClasses.Lecturer: " + lecturer.getfname() + " " + lecturer.getlname());
        } else {
            System.out.println("BaseClasses.Lecturer: Not assigned");
        }
