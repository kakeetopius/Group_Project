...
public class GUIHelper {
    private static GUI2 mainGUI;

    public static void setMainGUI(GUI2 gui) {
        mainGUI = gui;
    }
    ...
    public static void setHeader(JPanel panel, String title) {
        ...
        logoutLabel.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 20));
    ...
    public static void logout() {
        if (mainGUI != null) {
            ...
            System.err.println("MainGUI instance is not set in LogoutUtil.");
        }
    }
